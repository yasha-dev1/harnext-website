...
import Cmd from "@/components/landing/cmd";
import HeroTerminal from "@/components/landing/hero-terminal";
import Dashboard from "@/components/landing/dashboard";
import { HeroFlow, ContextFlow } from "@/components/landing/flows";
import { GithubIcon, StarIcon, XIcon, LogoSymbol } from "@/components/landing/icons";

const GITHUB_ORG = "QualityUnit";
const GITHUB_URL = `https://github.com/${GITHUB_ORG}/harnext`;
const CONTEXT_ENGINE_URL = `https://github.com/${GITHUB_ORG}/context-engine`;
    ...
    <section className="hero">
      ...
      <div className="container">
        ...
        <div className="hero-split">
          {/* LEFT · harnext */}
          <Reveal as="article" className="hpanel d2">
            ...
            <div className="hp-cta">
              ...
              <a className="btn btn-ghost" href="#harnext">Explore →</a>
            </div>
          </Reveal>

          {/* RIGHT · Context Engine */}
          <Reveal as="article" className="hpanel d3">
            <div className="hp-top">
            ...
            <HeroFlow />
            <div className="hp-cta">
              <a className="btn btn-ghost" href="#context">See how →</a>
            </div>
          </Reveal>
        </div>
      </div>
  ...
  return (
    <footer className="footer">
      <div className="container footer-in">
        ...
        <a className="fl" href="#harnext">harnext</a>
        <a className="fl" href="#context">Context Engine</a>
        <a className="fl" href="#start">Quick start</a>
        <a className="fl" href="#opensource">Open source</a>
